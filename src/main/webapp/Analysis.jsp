...
<body>
  ...
  <div class="login-container">
    <div class="login-box">
    <form method="post" action="AnalysisServlet" class="register-form" id="login-form">
      <h2>Analysis</h2>
        <div class="user-box">
       ...
       <div class="user-box">
          <input type="month" name="from_date" id="from_date" required>
          <label for="from_date">From</label>
        </div>
        <div class="user-box">
          <input type="month" name="to_date" id="to_date" required>

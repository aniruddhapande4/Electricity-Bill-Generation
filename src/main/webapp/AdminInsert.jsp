...
<body>
  ...
  <div class="login-container">
    <div class="login-box">
    <form method="post" action="AdminInsertServlet" class="register-form" id="login-form">
      <h2>Add Readings</h2>
      <div class="user-box">
        ...
        <div class="user-box">
          <input type="month" name="readingdate" id="readingdate" required>
          <div class="xx">
              <label for="readingdate">Reading Month and Year:</label>
          </div>
        </div>
       <div class="user-box">
      ...
      <% String error = request.getParameter("error");
            if (error != null && error.equals("1")) { %>
                <p style="color: red;">Current Reading cannot be Smaller Than Previous Reading</p>
        <% } %>
        <% String error1 = request.getParameter("error1");
            if (error1 != null && error1.equals("1")) { %>
                <p style="color: red;">Date is Wrong</p>
        <% } %>
    </div>
  </div>
        ...
        $.ajax({
          ...
          success: function(response) {
            if (response.success) {
              ...
              window.location.href = 'AdminInsert.jsp'; // Redirect if needed
            } else {

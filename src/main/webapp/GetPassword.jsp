  ...
  <div class="login-container">
    <div class="login-box">
      ...
      <% String error1 = request.getParameter("error1");
        ...
        <% } %>
        <% String error2 = request.getParameter("error3");
          if (error2 != null && error2.equals("1")) { %>
          <p style="color: red;">Error</p>
        <% } %>
      <form method="post" action="GetPasswordServlet" class="register-form" id="login-form">
        <div class="user-box">
        ...
        <div class="create-account">
        <a href="Registration.jsp" style="margin-top: 20px;">Back</a>
        </div>
      </form>
    </div>
  </div>
        ...
        $.ajax({
          ...
          success: function(response) {
            if (response.success) {
              ...
              window.location.href = 'Login.jsp'; // Redirect if needed
            } else {
              alert('Failed to set password: ' + response.message);
            }
          },
          error: function() {

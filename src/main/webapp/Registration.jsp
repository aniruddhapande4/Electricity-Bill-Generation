...
<body>
  ...
  <div class="login-container">
    <div class="login-box">
      <h2>Registration</h2>
      <form method="post" action="RegistrationServlet" class="register-form" id="login-form">
        <div class="user-box">
          <input type="number" name="consumer_no" id="consumer_no" required>
        ...
        <div class="create-account">
          <a href="Login.jsp" style="margin-top: 20px;">Account already exist! Login</a>
        </div>
        <% String error1 = request.getParameter("error1");
          if (error1 != null && error1.equals("1")) { %>
          <p style="color: red;">Consumer Doesn't Exist</p>
        <% } %>
        <% String error2 = request.getParameter("error2");
          if (error2 != null && error2.equals("1")) { %>
          <p style="color: red;">Account Already Exists, Please Login Directly</p>
        <% } %>
        <% String error3 = request.getParameter("error3");
  			if (error3 != null && error3.equals("1")) { %>
  			<p style="color: red;">Password must contain at least one capital letter, one small letter, and one special character.</p>
		<% } %>
  ...
  <script type="text/javascript">
    document.querySelector('form').addEventListener('submit', function(e) {
      ...
      if (!passwordRegex.test(password)) {
        e.preventDefault();
        alert('Password must contain at least one capital letter, one small letter, and one special character.');
      }
    });
  </script>
</body>
